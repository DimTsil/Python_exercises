...
def print_sortedList(sorted_jsonList, json_response):
    ...
    if json_response['positives'] == 0:
        ...
        print("The antiviruses which found your file infected are: ")
...
if __name__ == '__main__':
    ...
    while os.path.getsize(file_name) > 32000000: # Finding the size of user's file because the api accepts not more than 32MB
        print("\nYour file should be not more than 32MB")
        file_name = input('Please, give the name of your file to upload: ')
